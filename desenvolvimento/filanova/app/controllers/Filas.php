           ...
           // $this->view('filas/sucessoCadastrar', $data = 0);
            ...
            if($_SERVER['REQUEST_METHOD'] == 'POST'){
                ...
                $data = [
                    ...
                    'turno_desejado' => html($_POST['turno_desejado']),        
                    'obs'  => html($_POST['obs']),
                    'responsavel_err' => '',
                    'cpf_err' => '',
                    'email_err' => '',
                ...
                if(empty($data['turno_desejado'])){
                    $data['turno_desejado_err'] = 'Por favor informe o turno desejado';        
                } 
               ...
               // $data['posicao'] = $this->filaModel->buscaPosicaoFila($data['protocolo']);
                ...
                flash('cadastro_sucesso','Seu cadastro foi realizado com sucesso');
