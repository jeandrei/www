...
<head> 
    ...
    <title>Fila Única de Penha/SC</title>
...
<div class="container" style="margin-top: 90px;">
    ...
    <div class="row">
        <div class="col-lg-12">
            <blockquote style="border-left-color: #0D54AA; ">
    ...
    <div class="row" style="margin-bottom: 10px;">
        <div class="col-lg-2">
            <button class="btn btn-default btn-block" onclick="window.history.go(-1); return false;">
        ...
        <div class="col-lg-12" id="result">
            ...
            <ul class="nav nav-tabs" role="tablist" id="myTabs">
                ...
                <li role="presentation">
                    <a href="#childrem" aria-controls="childrem" role="tab" data-toggle="tab">
                        <i class="fa fa-list" aria-hidden="true"></i>
                        2º Etapa
                    </a>
                </li>
            ...
            <div role="tabpanel" class="tab-pane active" id="identificacao">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        ...
                        <blockquote style="border-left-color: #008a00; font-size: unset;">
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    ...
                                    <select name="bairro" id="bairro" class="form-control form-control-lg">
                        ...
                        <!--BLOCO AMARELO-->
                        <blockquote style="border-left-color: #F4C20B; font-size: unset;">
                    ...
                    <div class="col-lg-6">
                        <!--BLOCO AZUL-->
                        <blockquote style="border-left-color: #0c85d0; font-size: unset;">
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    ...
                                    <select name="setor1" id="setor1" class="form-control form-control-lg">
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control form-control-lg" id="turno1">
                                            <option></option>
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    ...
                                    <select name="setor2" id="setor2" class="form-control form-control-lg">
                                        <option value="0">-</option>
                                        <option value="102">CMEI - Abelhinha Feliz 1 (Alto São Bento)</option>
                                        <option value="120">CMEI - Abelhinha Feliz 2 (Alto São Bento)</option>
                                        <option value="35">CMEI - Alto São Bento (Alto São Bento)</option>
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control form-control-lg" id="turno2">
                                            <option></option>
                                            <option value="1">Matutino</option><option value="2">Vespertino</option><option value="3">Integral</option>                                                </select>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    ...
                                    <select name="setor3" id="setor3" class="form-control form-control-lg">
                                        <option value="0">-</option>
                                        <option value="102">CMEI - Abelhinha Feliz 1 (Alto São Bento)</option>
                                        <option value="120">CMEI - Abelhinha Feliz 2 (Alto São Bento)</option>
                                        <option value="35">CMEI - Alto São Bento (Alto São Bento)</option>
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control form-control-lg" id="turno3">
                                            <option></option>
                                            <option value="1">Matutino</option><option value="2">Vespertino</option><option value="3">Integral</option>                                            </select>
                                    </div>
                                </div>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <button class="btn btn-primary btn-block" onclick="segunda('childrem');">
...
<script>
function segunda(aba) {
	return $('#myTabs a[href="#' + aba + '"]').tab('show');
}
