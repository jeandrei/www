...
{
	//$pdo = new PDO('mysql:host=fdb7.leadhoster.com;dbname=2063807_labdb', '2063807_labdb', 'proinfourbano832008');
	$pdo = new PDO('mysql:host=localhost;dbname=labdb', 'labdbuser', 'proinfourbano');
