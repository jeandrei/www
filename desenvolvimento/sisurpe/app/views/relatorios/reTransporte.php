...
{            
            ...
            $colunas =array("N","Nome do Aluno","linha", "Etapa", "Turno", "Linha");
            //largura das colunas
           ...
           if(!empty($data)){
                    foreach($data as $row){
                        ...
                        if($linha != $row->linha){  
                            ...
                            $pdf->Cell(0, 5,"Linha: " . utf8_decode($row->linha), 0, 1, "C");
                            $countlinha=1;                       
                            $pdf->Ln();
                            // COLUNAS
                        ...
                        $pdf->Cell($larguracoll[6],$left,utf8_decode($row->linha),1);                                            
