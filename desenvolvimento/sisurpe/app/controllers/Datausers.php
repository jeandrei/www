    ...
    public function __construct(){                
     ...
     public function index(){
        ...
        $data = [
            ...
            'nome_pai' => strtoupper($datauser->nome_pai),
            'telefone_pai' => $datauser->telefone_pai,
            'nome_mae' => strtoupper($datauser->nome_mae),
            'telefone_mae' => $datauser->telefone_mae,
            'nome_responsavel' => strtoupper($datauser->nome_responsavel),
            'telefone_resp' => $datauser->telefone_resp,
            'naturalidade' => strtoupper($datauser->naturalidade), 
            'nacionalidade' => strtoupper($datauser->nacionalidade), 
            'rg' => $datauser->rg, 
            'uf_rg' => $datauser->uf_rg,
            'orgao_emissor' => strtoupper($datauser->orgao_emissor),
            'titulo_eleitor' => $datauser->titulo_eleitor,
            'zona' => $datauser->zona,
            'secao' => $datauser->secao,
            'certidao' => strtoupper($datauser->certidao),
            'uf_cert' => $datauser->uf_cert,
            'cartorio_cert' => strtoupper($datauser->cartorio_cert),
            ...
            'municipio_cert' => strtoupper($datauser->municipio_cert),
            'cpf' => $datauser->cpf,
            'tipo_sanguineo' => strtoupper($datauser->tipo_sanguineo),
            'fazUsoMed' => $datauser->fazUsoMed,
            'medicamentos' => strtoupper($datauser->medicamentos),
            'alergias' => strtoupper($datauser->alergias),
            'deficiencias' => strtoupper($datauser->deficiencias),
            'restric_alimentos' => strtoupper($datauser->restric_alimentos)     
        ];
    ...
    public function add(){
          ...
          if($_SERVER['REQUEST_METHOD'] == 'POST'){
            ...
            $data = [              
              ...
              'nome_pai' => strtoupper(trim($_POST['nome_pai'])),
              'telefone_pai' => $_POST['telefone_pai'],
              'nome_mae' => strtoupper(trim($_POST['nome_mae'])),
              'telefone_mae' => $_POST['telefone_mae'],
              'nome_responsavel' => strtoupper(trim($_POST['nome_responsavel'])),
              'telefone_resp' => $_POST['telefone_resp'],
              'naturalidade' => strtoupper(trim($_POST['naturalidade'])),
              'nacionalidade' => strtoupper(trim($_POST['nacionalidade'])),
              'rg' => trim($_POST['rg']),
              'uf_rg' => $_POST['uf_rg'],
              'orgao_emissor' => strtoupper(trim($_POST['orgao_emissor'])),
              'titulo_eleitor' => trim($_POST['titulo_eleitor']),
              'zona' => trim($_POST['zona']),
              'secao' => trim($_POST['secao']),
              'certidao' => strtoupper(trim($_POST['certidao'])),
              'uf_cert' => $_POST['uf_cert'],
              'cartorio_cert' => strtoupper(trim($_POST['cartorio_cert'])),
              'modelo' => $_POST['modelo'],
              'numero' => trim($_POST['numero']),
              'folha' => trim($_POST['folha']),
              'livro' => trim($_POST['livro']),
              'data_emissao_cert' => $_POST['data_emissao_cert'],
              'municipio_cert' => strtoupper(trim($_POST['municipio_cert'])),
              'cpf' => $_POST['cpf'],
              'tipo_sanguineo' => strtoupper(trim($_POST['tipo_sanguineo'])),
              'fazUsoMed' => trim($_POST['fazUsoMed']),
              'medicamentos' => strtoupper(trim($_POST['medicamentos'])),
              'alergias' => strtoupper(trim($_POST['alergias'])),
              'deficiencias' => strtoupper(trim($_POST['deficiencias'])),
              'restric_alimentos' => strtoupper(trim($_POST['restric_alimentos'])) 
          ];
